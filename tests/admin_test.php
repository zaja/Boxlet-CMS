...
test('every admin stylesheet on disk is one this file checks', function () {
    ...
    foreach (glob(dirname(__DIR__) . '/public/assets/*.css') ?: [] as $file) {
        ...
        if (in_array($name, ['site.css', 'blocks-hero.css', 'blocks.css', 'blocks-words.css', 'blocks-media.css', 'chrome.css', 'chrome-header.css', 'sections.css', 'maintenance-bar.css'], true)) {
            continue;
        }
