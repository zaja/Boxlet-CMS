...
return [
    ...
    'menus.item.url_hint' => 'Filled in when you choose a page. For anything else — another site, an email, a phone number — leave the page empty and type the address: /contact, https://example.com, mailto:you@example.com, tel:+385….',
