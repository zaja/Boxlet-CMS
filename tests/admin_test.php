...
test('every admin stylesheet on disk is one this file checks', function () {
    ...
    foreach (glob(dirname(__DIR__) . '/public/assets/*.css') ?: [] as $file) {
        ...
        if (in_array($name, ['site.css', 'blocks-hero.css', 'blocks.css', 'blocks-words.css', 'blocks-media.css', 'blocks-downloads.css', 'chrome.css', 'chrome-header.css', 'sections.css', 'maintenance-bar.css'], true)) {
            continue;
        }
...
test('the front-end stylesheets are linked with a hash of their content', function () {
    ...
    foreach (['site.css', 'blocks-hero.css', 'blocks.css', 'blocks-words.css', 'blocks-media.css', 'blocks-downloads.css', 'chrome.css', 'chrome-header.css', 'sections.css'] as $css) {
