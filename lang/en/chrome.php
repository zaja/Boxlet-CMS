...
return [
    ...
    'chrome.text_hint' => 'A line or two at the foot of every page — who you are, where to find you. Bold, italic and links; an email address or a phone number as a link opens the visitor’s mail app or dialler.',
    ...
    'chrome.footer_menu' => 'Footer menu',
    'chrome.footer_menu_same' => 'Same as the header',
    'chrome.footer_menu_hint' => 'The header’s menu again, none, or a menu of the footer’s own — Privacy, Imprint, Terms. Built under Menus, chosen by name, so each language’s menu of that name is the footer’s.',
    ...
    'chrome.look.footer_layout.menu_first' => 'Menu first',
    'chrome.look.footer_layout.three' => 'Three columns',
    'chrome.look.footer_edge' => 'Footer edge',
    'chrome.look.footer_edge.none' => 'None',
    'chrome.look.footer_edge.line' => 'Line',
    'chrome.look.footer_edge.slant' => 'Slant',
    'chrome.look.footer_edge.curve' => 'Curve',
    'chrome.look.small_print_row' => 'Last row',
    'chrome.look.small_print_row.left' => 'Stacked',
    'chrome.look.small_print_row.split' => 'Split',
    'chrome.look.small_print_row.centred' => 'Centred',
