...
return [
    ...
    'hint.design.footer_width' => 'Where the footer’s words and menu start and end: in line with the text of the page, or with the edges of the page — the boxed page’s edges when it is boxed, the window’s when it is not. Like the header’s.',
    'hint.design.header_width' => 'Where the logo, the menu and the button start and end: in line with the text of the page, or with the edges of the page — the boxed page’s edges when it is boxed, the window’s when it is not.',
    ...
    'hint.design.header_bleed' => 'Whether the header’s colour stays on the boxed page or runs across the whole window above it. Its contents line up as chosen above either way. A header laid over the first section can only do that on the page.',
    'hint.design.footer_bleed' => 'The same for the footer: its colour on the boxed page, or across the whole window below it.',
