...
<?php endforeach; ?>
        ...
        <section class="panel stats-trend" aria-labelledby="stats-trend-heading">
            <div class="stats-trend-head">
                <h2 id="stats-trend-heading"><?= e(t($chartWeek ? 'stats.trend_week' : ($period === '12m' ? 'stats.trend_weekly' : 'stats.trend'))) ?></h2>
            ...
            <details class="stats-numbers">
                ...
                <table class="stats-table">
                    <thead><tr>
                        <th scope="col"><?= e(t($period === '12m' ? 'stats.week_of' : 'stats.day')) ?></th>
...
<?php if (count($rows) >= 10): ?>
                <p class="stats-more"><a href="<?= e(Url::admin('statistics') . '?' . http_build_query(['period' => $period, 'all' => $dimension])) ?>"><?= e(t('stats.show_all')) ?></a></p>
<?php endif; ?>
            </section>
<?php endforeach; ?>
        </div>
