...
return [
    ...
    'hint.design.frame' => 'How much room there is at the sides, between the sheet and the edge of the window, when the window is narrower than the sheet. Only shows on a boxed page.',
